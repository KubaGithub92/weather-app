  ...
  useEffect(() => {
    ...
    const getWeather = async () => {
      const res = await fetch(
        `https://api.openweathermap.org/data/2.5/weather?lat=${+lat}&lon=${+lon}&appid=2fbfbc253342eb2b91b2823c547a3b12`
      );
        ...
        <div className="card">
          <div className="card__top">
            ...
            <div className="card__top-temp">
              ...
              <div className="card__top-temp-deg">
                {Math.round(weatherData.main.temp - absoluteZero)}°C
              </div>
            </div>
            <div className="card__top-degrees">
              <div className="degrees__max">
                <span>Max </span>
                {Math.round(weatherData.main.temp_max - absoluteZero)}°C
              </div>
              <div className="degrees__min">
                <span>Min </span>
                {Math.round(weatherData.main.temp_min - absoluteZero)}°C
              </div>
            </div>
          </div>
